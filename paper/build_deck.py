...
<div class="grid2" style="margin-top:22px">
  ...
  <div class="card good"><div class="k">5 &middot; Auto loop</div><div class="v"><b>Runs today:</b> one run spec, span study first, budget and pass gates, verified teardown. <b>Built on top:</b> failure triage, lessons turned into checks, gated promotion, and a next-recipe proposer a person approves.</div></div>
</div>''')
...
<h2>On a larger GPU, the peak gain was near zero</h2>
<div class="grid2" style="margin-top:1rem">
  <div class="card"><div class="k">H100 NVL &middot; 95 GB</div>
    <div style="display:flex;gap:30px;flex-wrap:wrap;margin-top:.4rem">
      <div><div class="bignum" style="color:#8a9aa0">42.7</div><div class="unit">full prompt</div></div>
      <div><div class="bignum plum">61.3</div><div class="unit">Steno 8:1 &middot; +44%%</div></div>
    </div></div>
  <div class="card"><div class="k">H200 NVL &middot; 143 GB</div>
    <div style="display:flex;gap:30px;flex-wrap:wrap;margin-top:.4rem">
      <div><div class="bignum petrol">85.3</div><div class="unit">full prompt</div></div>
      <div><div class="bignum plum">83.3</div><div class="unit">Steno 8:1 &middot; &minus;2%%</div></div>
    </div></div>
</div>
<p class="caption" style="margin-top:.6rem">peak replay requests per minute</p>
<p class="lead" style="margin-top:1rem">The two are <b>indistinguishable at peak</b> on the H200: the full-prompt runs swung by up to 26 req/min between repeats of the same test, while Steno repeated almost exactly. Per rental dollar, the H100 with Steno and the H200 without it come out <b>roughly even</b> (appendix B).</p>
<p style="margin-top:1rem"><span class="tag warn">two repeats &middot; H100-tuned server settings</span></p>''' .replace("%%","%"))
