...
<p class="caption">One controller ran this pair&rsquo;s recipe end to end, unattended. The next experiment will establish what transfers to a new pair and what needs adaptation.</p>''')
