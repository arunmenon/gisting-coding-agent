...
<div class="grid3" style="margin-top:1rem">
  ...
  <div class="card"><div class="k">3 &middot; Proxy</div><div class="v">Sits in front of the model and swaps the fixed span for the Steno tokens. The agent and serving engine are unchanged.</div></div>
</div>
<div class="grid2" style="margin-top:22px">
  ...
  <div class="card good"><div class="k">5 &middot; Auto loop</div><div class="v">A controller that provisions a GPU, trains, serves, evaluates, syncs results and tears down, with spend guards. Most experiments after the first ran through it.</div></div>
</div>''')
...
<p class="caption">Most experiments after the first ran through this controller rather than by hand. The next experiment will establish what transfers to a new pair and what needs adaptation.</p>''')
